        ...
        return (
          <div key={col.id}>
            ...
            <div className="flex items-center gap-2 mb-3 px-1">
              ...
              <span className="text-label" style={{ color: 'var(--color-slate-400)' }}>{col.label}</span>
              <span className="badge badge-neutral" style={{ marginLeft: 4 }}>
                {columnTasks.length}
              </span>
              <div className="flex-1 h-px ml-2" style={{ background: 'var(--color-surface-300)' }} />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              {columnTasks.length === 0 && (
                <div
                  ...
                  style={{ border: '2px dashed var(--color-surface-300)', borderRadius: 'var(--radius-md)' }}
                >
                  <p className="text-body-small" style={{ color: 'var(--color-slate-400)' }}>No tasks</p>
                </div>
              )}
            </div>
          </div>
